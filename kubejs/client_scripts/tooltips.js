(function () {
  ItemEvents.tooltip((event) => {
    ...
    event.add(
      'kubejs:infinity_9',
      Text.translate('tooltip.kubejs.infinity_9_1')
    );
    event.add(
      'kubejs:infinity_9',
      Text.translate('tooltip.kubejs.infinity_9_2')
    );
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        if (!event.shift) {
          ...
          text.add(
            1,
            Text.translate('tooltip.mekanism_extras.naquadah').green()
          );
        }
        text.remove(2);
      }
    ...
    event.addAdvanced(['armorplus:frost_crystal'], (item, advanced, text) => {
      if (!event.shift) {
        ...
        text.add(
          1,
          Text.translate('tooltip.armorplus.frost_crystal_1').green()
        );
        text.add(
          2,
          Text.translate('tooltip.armorplus.frost_crystal_2').white()
        );
        text.remove(3);
      }
    });
    ...
    event.addAdvanced(kemCredits, (item, advanced, text) => {
      text.add(
        1,
        Text.translate('tooltip.credit.recipe_added', 'Kem5540').red()
      );
    });
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        text.add(
          1,
          Text.translate('tooltip.born_in_chaos.pumpkinhead').green()
        );
      }
    );
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        text.add(
          1,
          Text.translate(
            'tooltip.credit.recipe_item_added',
            'realspinelle'
          ).red()
        );
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        text.add(
          1,
          Text.translate('tooltip.credit.recipe_added', 'Anti').red()
        );
      }
    );
    ...
    for (const material of mekanismEnrichedMaterialsToCompress) {
      event.add(
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        text.add(
          1,
          Text.translate(
            'tooltip.kubejs.universal_wireless_terminal_uncrafter_1'
          )
        );
        text.add(
          2,
          Text.translate(
            'tooltip.kubejs.universal_wireless_terminal_uncrafter_2'
          )
        );
        text.add(
          3,
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        if (
          item.nbt.data_model.id ==
          'hostilenetworks:born_in_chaos/lord_pumpkinhead'
        ) {
          text.add(
            Text.translate(
    ...
    event.addAdvanced(
      ...
      (item, advanced, text) => {
        ...
        const chemical_name = Text.translatable(
          chemicalTK + second
        ).getString();
        const mod_name = Platform.mods[first].name;
    ...
    for (const cake of Object.keys(cakes)) {
    ...
    event.addAdvanced(
      'botanicalextramachinery:catalyst_speed',
      (item, advanced, text) => {
        text.add(
          1,
          Text.translate(
            'tooltip.kubejs.botanicalextramachinery_catalyst_speed'
          )
        );
      }
    );
